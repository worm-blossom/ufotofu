...
// Generate a random linked list, call into_producer, scramble that producer. Then use IntoConsumer on the empty linked list, scramble the consumer, and check that the original list is being reconstructed.
...
fuzz_target!(|data: (
    ...
    pollster::block_on(async {
        ...
        let mut con = LinkedList::default()
            .into_consumer()
        ...
        let consumed: LinkedList<u16> = con.into_inner().into();
