...
// Generate a random btree set, call into_producer, scramble that producer. Then use IntoConsumer on the empty btree set, scramble the consumer, and check that the original set is being reconstructed.
