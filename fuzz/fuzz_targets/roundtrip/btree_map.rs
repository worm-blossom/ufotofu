...
// Generate a random btree map, call into_producer, scramble that producer. Then use IntoConsumer on the default btree map, scramble the consumer, and check that the original map is being reconstructed.
...
fuzz_target!(|data: (
    ...
    pollster::block_on(async {
        ...
        let consumed: BTreeMap<u16, u16> = con.into_inner().into();
