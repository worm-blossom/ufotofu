...
// Generate a random hashset, call into_producer, scramble that producer. Then use IntoConsumer on the empty hashset, scramble the consumer, and check that the original set is being reconstructed.
...
fuzz_target!(|data: (
    ...
    pollster::block_on(async {
        ...
        let consumed: HashSet<u16> = con.into_inner().into();
