...
// Generate a TestProducer, turn it into a scrambler, and test that the resulting producer produces the same sequence as the original producer.
...
fuzz_target!(|data: (
    ...
    pollster::block_on(async {
        ...
        let mut scrambled = pro.scrambled(new_fixed(buffer_size), ops);
