...
// Check that a CloneFromSlice produces the same sequence as the IntoProducer of Vec for the same data.
...
fuzz_target!(|data: (Vec<u16>, usize, Vec<BulkProducerOperation>)| {
    pollster::block_on(async {
        ...
        let mut scrambled = producer::clone_from_slice(&slice_data[..])
